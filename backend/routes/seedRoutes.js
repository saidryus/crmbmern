...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: 260, category: 'Bread',
    image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80',
    available: true, bestSeller: false, tags: ['Vegan', 'Contains Nuts', 'Contains Gluten'],
  },
  {
    name: 'Caramel Macchiato',
    description: 'Espresso layered over vanilla-infused milk with a drizzle of house-made caramel.',
    price: 175, category: 'Drinks',
    image: 'https://images.unsplash.com/photo-1485808191679-5f86510bd9d4?w=600&q=80',
    available: true, bestSeller: true, tags: ['Contains Dairy', 'Seasonal'],
  },
  {
    ...
    available: true, bestSeller: false, tags: ['New', 'Contains Gluten'],
  },
];

// GET /api/seed
// Clears and re-seeds the database. Remove this route after first use.
router.get('/', async (req, res) => {
  try {
    ...
    res.json({ message: `Seeded ${PRODUCTS.length} products and 1 admin account.` });
  } catch (err) {
